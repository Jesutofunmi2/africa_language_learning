            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 offset-2 mr-auto">
                    <div class="card card-signup text-center">
                        ...
                        <div class="card-body ">
                            <form class="form" method="POST" action="{{ route('admin.language.update', $language->id) }}"
                                ...
                                <input type="file" value="{{ old('image_url') ?? $language->image_url }}"
                                    name="image_url" accept="image/*" class="form-control" />
                                @if ($errors->has('image_url'))
                                    <span class="invalid-feedback" style="display: block;" role="alert">
                                        <strong>{{ $errors->first('image_url') }}</strong>
                                    </span>
                                @endif
                                <img src="{{ asset($language->image_url) }}" width="200px" height="200px" alt=""
                                    srcset="">
