                        ...
                        <div class="card-body">
                            <form class="form" method="POST" action="{{ route('admin.course.update', $course->id ) }}" enctype="multipart/form-data">
                                ...
                                <div class="input-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                    ...
                                    <input name="title" type="text" class="form-control" placeholder="Course name" value="{{ old('title') ?? $course->title }}" required autofocus>
                                    @if ($errors->has('title'))
                                ...
                                <input type="file" value="{{ old('image_url')  ?? $course->image_url}}" name="image_url" accept="image/*" class="form-control" />
