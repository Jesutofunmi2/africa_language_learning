            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 offset-2 mr-auto">
                    <div class="card card-signup text-center">
                        ...
                        <div class="card-body">
                            <form class="form" method="POST" action="{{ route('admin.section.update', $section->id) }}"
                                    ...
                                    <div class="form-group">
                                        <select name="course_id" class="form-control">
                                            <option value="{{ old('course_id') }}">
                                                {{ $section->course->title ?? 'Select Course' }}</option>
                                ...
                                <div class="row-12">
                                    <div class="form-group">
                                        <select name="level" class="form-control">
                                            <option value="{{ old('level') }}">{{ $section->level ?? 'Select leve' }}
                                            </option>
